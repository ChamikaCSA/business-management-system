...
public class SupplierService {
    private final NavigableMap<String, Supplier> supplierRegistry = new TreeMap<>();
    ...
    public boolean hasGoodsReceiveNotes(String supplierId) {
        String sql = "SELECT COUNT(*) FROM GoodsReceiveNotes WHERE supplierId = ?";
        try (Connection conn = DBConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
    ...
    public int getSupplierCount() {
        ...
        String lastId = supplierRegistry.lastKey();
