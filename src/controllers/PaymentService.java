...
public class PaymentService {
    ...
    private final NavigableMap<String, Payment> paymentRegistry = new TreeMap<>();
    ...
    public void deletePaymentByInvoice(String invoiceId) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            paymentRegistry.entrySet().removeIf(entry -> entry.getValue().getInvoice().getId().equals(invoiceId));
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public int getPaymentCount() {
        if (paymentRegistry.isEmpty()) {
            return 0;
        }
        String lastId = paymentRegistry.lastKey();
